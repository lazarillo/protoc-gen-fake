...
// Include the protobuf-codegen generated code for your custom message.
// This file will now be found in `src/gen/fake_field.rs` after `build.rs` copies it.
// Removed `#[allow(clippy::all)]` and `#[allow(unknown_lints)]` here
// as they are present in the generated file itself and cause "inner attribute" errors.
pub mod gen_fake {
