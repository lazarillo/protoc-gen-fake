...
fn main() -> io::Result<()> {
    ...
    let fake_data_field_extension_descriptor_owned: ExtensionDescriptor = (&*DESCRIPTOR_POOL)
            ...
            if files_to_generate.contains(file_name) {
                ...
                for message_type in &file_descriptor.message_type {
                    ...
                    for field in &message_type.field {
                        ...
                        let option_value_cow: Cow<'_, Value> = field_options_reflect
                            .get_extension(&fake_data_field_extension_descriptor_owned);
